...
budget = 2000 * gold  # Maximum gold spend, slightly increases runtime
...
click_weight = 10  # Up this if you waint more lines but larger chunks

solveroptions = {"threads": 8, "fracGap": 0.1, "maxSeconds": 120} # Options for the cbc solver
